...
import com.raywenderlich.android.majesticreader.BookmarkDataSource
...
class RoomBookmarkDataSource(context: Context) : BookmarkDataSource {
    ...
    // use MajesticReaderDatabase to get an instance of BookmarkDao
    // and store in it in local field
